...
值得一提的是，从讲稿到成书的这段“整理、扩展”，本身就用到了书中反复讨论的方法——一种可以称为 **whisper coding**（口述式协作）的工作方式。多数时候我并不打字，而是把要讲的内容口述给 Agent，与它反复讨论、辩驳，再由它把结论整理、扩写为书中的文字。语音的带宽远高于打字（正常说话的速度约为打字的四倍），“口述—讨论—整理”的循环因此转得很快。某种意义上，这本书既是在讲 Agent，也是一件由 Agent 参与做成的作品。
...
这些原则的底气，来自把 Agent 真正推进高风险场景的实战。作为 Pine AI 的首席科学家，我和团队打造了 Pine。据我所知，它是第一个能够自主与真人交互、并可靠地独立处理涉及金钱的敏感、复杂、长程任务的通用 Agent：它替用户打电话与运营商协商账单、与商家交涉退款和投诉、取消订阅，全程无需人工接管。这类任务动辄几十轮交涉，任何一步出错都会造成真金白银的损失。正是这种对可靠性近乎苛刻的要求，把本书反复强调的架构原则一条条倒逼了出来。下面几个例子，就来自这段实践（本书中反复出现的“我们”，也多指向它）。
